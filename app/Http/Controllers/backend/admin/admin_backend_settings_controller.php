...
class admin_backend_settings_controller extends Controller
{
    ...
    */
    ...
    // admin_settings_edit_textfile_controller
    public function admin_settings_edit_textfile_controller(Request $req)
    {

        File::put(base_path('index.txt'), $req->txt);

        return back() -> with('msg', 'Your text file success updated!');
    }
}
