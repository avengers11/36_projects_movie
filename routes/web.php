...
Route::middleware(['users'])->group(function () {
    ...
    Route::get('/server2', [users_frontend_deshbord_controller::class, 'users_home_controller']) -> name('users_server2tv_web');//users_server2tv_controller
    Route::get('/server3', [users_frontend_deshbord_controller::class, 'users_home_controller']) -> name('users_livetv_web');//users_livetv_controller
    Route::get('/profile', [users_frontend_deshbord_controller::class, 'users_profile_controller']) -> name('users_profile_web');
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::prefix('settings')->group(function () {
            ...
            Route::get('texteditor', [admin_frontend_setting_Controller::class, 'admin_settings_texteditor_controller']) -> name('settings.admin_texteditor_web');
