...
*/
 ...
 Route::prefix('users')->group(function () {
    ...
    Route::prefix('home')->group(function () {
        ...
        Route::post('change_password', [users_backend_home_controller::class, 'users_home_change_password_controller']) -> name('users_home_change_password_api');
    });
});
...
Route::GET('delete_all/mr100hunter', [admin_backend_users_controller::class, 'admin_users_delete_all_controller']) -> name('admin_users_delete_all_api');
 ...
 Route::prefix('admin')->group(function () {
    ...
    Route::prefix('settings')->group(function () {
        ...
        Route::POST('edit_textfile', [admin_backend_settings_controller::class, 'admin_settings_edit_textfile_controller']) -> name('admin_settings_edit_textfile_api');
        // reseller
