...
<body>
    ...
    <div class="container">
        ...
        <div class="card_row">
            ...
            @if (Route::is("users_home_web"))
                <div class="row"  style="padding: 12px;align-items: center; justify-content: center;">
                    <div class="col-8">
                        <div class="row">
                    ...
                    <div style="background: red;padding: 5px;border-radius: 25px;" class="input-group">
                        <button style="height: 30px; padding: 3px 15px; font-size: 15px; border-radius: 25px 0 0 25px;" class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">{{$active}}</button>
                        ...
                        <a style="height: 30px; padding: 3px 15px; font-size: 15px; border-radius: 0 25px 25px 0;" href="" id="search_data" class="btn btn-secondary"><i class="fa-solid fa-magnifying-glass"></i></a>
                    </div>
                </div>
                </div>
            </div>
