                    ...
                    @if (admin_data(session() -> get('username'))['role'] == "1")
                        ...
                        <li class="nav-item {{Route::is('settings.*') ? 'active' : ''}}" data-toggle="tooltip" data-placement="right" title="Settings">
                            ...
                            <ul class="sidenav-second-level {{Route::is('settings.*') ? 'show' : 'collapse'}}" id="collapseSettings">
                                ...
                                <li>
                                    <a style="{{Route::is('settings.admin_products_web') ? 'color: green !important' : ''}}" href="{{route('settings.admin_products_web')}}">SERVER 1</a></a>
                                </li>
                                <li>
                                    <a style="{{Route::is('settings.admin_update_links_web') ? 'color: green !important' : ''}}" href="{{route('settings.admin_update_links_web')}}">MOVIE LINKS</a></a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a style="{{Route::is('settings.admin_texteditor_web') ? 'color: green !important' : ''}}" href="{{route('settings.admin_texteditor_web')}}">Text Editor</a></a>
                                </li>
                            </ul>
                        </li>
                    @endif
